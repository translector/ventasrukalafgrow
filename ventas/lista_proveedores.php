...
<head>
  ...
  <title>Lista de Proveedores - Punto de Venta</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"><a href="#"><i class="fa fa-th"></i><span>Productos y Proveedores</span></a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="lista_proveedores.php"><i class="fa fa-circle-o"></i> Lista de Proveedores</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Lista de todos los proveedores actualmente</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  while ($row=mysql_fetch_array($q)) {
                    ...
                    echo "<tr>
                  <th>$num</th>
                  <th>$row[nombre_prove]</th>
                  <th>$row[email]</th>
                  <th>$row[fono]</th>
                  <th><a href='php/eliminar_proveedor.php?id_proveedor=$row[id_prove]'>Eliminar</a> - <a href='editar_proveedor.php?id=$row[id_prove]'>Editar</a></th>
                    </tr>";
                  }
                  ?>
                </tbody>
