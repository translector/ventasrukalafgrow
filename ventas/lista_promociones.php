...
<head>
  ...
  <title>Lista de Promociones - Punto de Venta</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Lista de Promociones</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Lista de todos las promociones activas actualmente</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <th>".$row["nombre"]."</th>
                  <th>$".$row["valor"]."</th>
                  <th><a href='php/eliminar_promocion.php?id_promocion=$row[id_promocion]'>Eliminar</a> - <a href='ver_promocion.php?id=$row[id_promocion]'>Revisar</a></th>
                    </tr>";
                  }
                  ?>
                </tbody>
