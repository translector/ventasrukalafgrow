...
$q = mysql_query("SELECT * FROM productos WHERE id_producto = '$id'");
...
<head>
  ...
  <title>Editar producto - Punto de Venta</title>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="php/editar_producto.php?id_producto=<?php echo $id; ?>" method="post" id="agregar_producto">
              <div class="box-body">
                <div class="form-group">
                  <label for="nombre_producto">Nombre Producto</label>
                  <input type="text" class="form-control" placeholder="Nombre Producto" name="nombre_producto" required="" value="<?php echo $row['nombre_producto']; ?>">
                </div>
                <div class="form-group">
                  <label for="precio_compra">Precio Compra</label>
                  <input type="text" class="form-control" placeholder="Precio Compra" name="precio_c" required="" value="<?php echo $row['precio_compra']; ?>">
                </div>
                <div class="form-group">
                  <label for="precio_venta">Precio Venta</label>
                  <input type="text" class="form-control" placeholder="Precio Venta" name="precio_v" required="" value="<?php echo $row['precio_venta']; ?>">
                </div>
                <div class="form-group">
                  ...
                  <select name="proveedor" class="form-control">
                    ...
                    while ($row2=mysql_fetch_array($q)) {
                      if ($row[proveedor] == $row2[id_prove]) {
                        echo "<option value='$row[id_prove]' selected>$row2[nombre_prove]</option>";
                      }else{
                        echo "<option value='$row[id_prove]' >$row2[nombre_prove]</option>";
                      }
                ...
                <div class="form-group">
                  <label for="nombre_producto"><h4>Codigo Producto</h4></label>
                  <input type="text" class="form-control" placeholder="Codigo Producto" name="codigo_producto" required="" value="<?php echo $row['codigo_producto']; ?>">
                </div>
              </div>
              <!-- /.box-body -->

              <div class="box-footer">
                <input type="submit" value="Enviar" name="editar_producto" class="btn btn-primary"/>
              </div>
            </form>
          </div>
          <!-- /.box -->
