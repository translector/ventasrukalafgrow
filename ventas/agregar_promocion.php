...
<head>
  ...
  <title>Agregar promoción - Punto de Venta</title>
...
function add_item(){
   ...
   //$("#productos-add").append("<b>Appended text</b><br>");
   //$('#productos').clone().appendTo('#productos-add');
   var $options = $("#productos").clone();

$('#productos-add').append($options);
 }
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"><a href="#"><i class="fa fa-th"></i><span>Productos y Proveedores</span></a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="agregar_promocion.php"><i class="fa fa-circle-o"></i> Agregar promoción</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Agregar nueva promoción a la base de datos
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="alert alert-success alert-dismissible">
        ...
        La promoción ha sido añadida correctamente.
      </div>
      <?php
      }
      ?>
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="php/add_promocion.php" method="post" id="agregar_proveedor">
              <div class="box-body">
                <div class="form-group">
                  <label for="nombre">Nombre</label>
                  <input type="text" class="form-control" placeholder="Nombre" id="nombre" required="" name="nombre">
                </div>
                <div class="form-group">
                  <label for="valor">Valor</label>
                  <input type="number" class="form-control" placeholder="Valor" id="valor" required="" name="valor">
                </div>
                <div class="form-group">
                  ...
                  <span class="glyphicon glyphicon-plus" onclick="add_item()"></span>
                  <div id="productos-add"></div>
                </div>
              </div>
              <!-- /.box-body -->
