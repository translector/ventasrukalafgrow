...
<head>
  ...
  <title>Revisar promoción - Punto de Venta</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"><a href="#"><i class="fa fa-th"></i><span>Productos y Proveedores</span></a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="lista_promociones.php"><i class="fa fa-circle-o"></i> Lista de promociones</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Revisar promoción de la base de datos
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li><a href="#">Productos y Proveedores</a></li>
        <li class="active">Revisar promoción</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Información de la promoción</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
           <!-- <form action="php/editar_proveedor.php?id_prove=<?php echo $id; ?>" method="post" id="agregar_proveedor">-->
              <div class="box-body">
                <?php
                $q = mysql_query("SELECT * FROM promociones WHERE id_promocion = '$id'");
                $row = mysql_fetch_array($q);
                ?>
                <div class="form-group">
                  <label for="nombre">Nombre:</label>
                  <input type="text" class="form-control" placeholder="Nombre" name="nombre_promocion" required="" value="<?php echo $row['nombre'] ?>" disabled>
                </div>
                <div class="form-group">
                  <label for="valor">Valor:</label>
                  <input type="valor_promocion" class="form-control" placeholder="Email" name="email" required="" value="$<?php echo $row['valor'] ?>" disabled>
                </div>
                <div class="form-group">
                  <label for="nombre">Productos añadidos a esta promoción:</label><br>
                  <?php 
                  $q = mysql_query("SELECT * FROM productos_promociones WHERE id_promocion = '$id'");
                  while ($row = mysql_fetch_array($q)) {
                    $l = mysql_query("SELECT * FROM productos WHERE id_producto = '".$row['id_producto']."'");
                    while ($lrow = mysql_fetch_array($l)) {
                      echo "<p>".$lrow["nombre_producto"]."</p>";
                    }
                  }
                  ?>
                </div>
